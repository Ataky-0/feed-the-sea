...
function newgame:load()
  ...
  self.inputs = {}
  table.insert(self.inputs, UI.newTextInput("Nome do Save ", "left", "Meu Oceano..", x, y, inputWidth, inputHeight, self.inputFont))
  ...
  self.createButton = UI.newButton(
    ...
    function()
      ...
      -- Todo: Mudar a cena para a de load game aqui
    end,
    self.navButtonsFont
  )
end
